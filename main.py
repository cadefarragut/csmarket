...
def getInventory(steamid):
    inventory = load_json(f"https://steamcommunity.com/inventory/{steamid}/730/2", "inv.json")
    print(inventory)
    for items in inventory["descriptions"]:
        print(items["market_hash_name"])
    #todo: Finish grabbing all information from inventory
...
def main():
    ...
    getInventory("76561198146131977")
